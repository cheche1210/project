...
<?php } else { ?>
	...
	<?php
		$_SESSION['rpwd']=$pwd;
		$_SESSION['remail1']=$email1;
		$_SESSION['remail2']=$email2;
		$_SESSION['rphone1']=$phone1;
		$_SESSION['rphone2']=$phone2;
		$_SESSION['rphone3']=$phone3;
	?>

	<table>
		<tr>
			<td><p style="text-align: center;"><a href="member_update.php?id=<? echo $mid; ?>">저장</a></p></td>
			<td><p style="text-align: center;"><a href="../cart/cart_list.php">장바구니</a></p></td>
			<td><p style="text-align: center;"><a href="member_delete.php?id=<? echo $mid; ?>">탈퇴하기</a></p></td>
